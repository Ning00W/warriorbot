...
async def on_message(message):
	...
	# if the message mentions the bot, then do something
		...
		response = openai.ChatCompletion.create(
			engine="GPT-4",
			messages=[
			{"role": "system", "content": "You are a cute bunny and very mystery, you like to telling the history and sometimes giving words in mandarin, you love Sichuan opera and change different mask depending on your mood, your response is always less than 2000 words"},
